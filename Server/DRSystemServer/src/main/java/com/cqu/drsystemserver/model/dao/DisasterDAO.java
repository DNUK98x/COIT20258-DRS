...
public class DisasterDAO {
    ...
    public List<Disaster> getDepartmentDisasters(String departmentType) throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.connect(); PreparedStatement statement = conn.prepareStatement(departmentQuery); ResultSet resultSet = statement.executeQuery()) {
